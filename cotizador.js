...
if (document.getElementById("uno").checked){
        ...
        console.log("------Nueva cotizacion------")
        console.log("$" + valore + " es igual a " + "$" + resultado.toFixed(2) + " euros.");
    }
        ...
        console.log("------Nueva cotizacion------")
        console.log("$" + valore + " es igual a " + "$" + resultado.toFixed(2) + " reales.");
    }
        ...
        console.log("------Nueva cotizacion------")
        console.log("$" + valore + " es igual a " + "$" + resultado.toFixed(2) + " pesos chilenos.");
    }
        ...
        console.log("------Nueva cotizacion------")
        console.log("$" + valore + " es igual a " + "$" + resultado.toFixed(2) + " soles.");
    }
